...
\begin{document}
    ...
    \begin{equation}
        \vb{\mu}=I\vu{n}A\,,
    \end{equation}
    where \(A\) the area enclosed by the circular wir and \(\vu{n}\) is the unit normal, such that placing the magnetic moment \(\vb{\mu}\) in a magnetic field \(\vb{B}\) will experience a torque
    \begin{equation}
    ...
    \end{equation}
    where \(g_L=1\) is the Land\'{e} \(g\)-factor for orbital angular momentum due to some reason that will be apparent immediately.
    ...
    \begin{ex}
        ...
        \begin{figure}[ht!]
            ...
            \begin{tikzpicture}
                ...
                \draw[arrows = {->[harpoon]}, thick] (-1.6,-0.3)--(-1.6,0.3);
    ...
    Free atoms and ions are of little interests to chemists. Instead, the materials showing the most interesting magnetic properties are the transition metal complexes, which will be the main topic of this course.
    ...
    \begin{ex}
        ...
        \begin{figure}[ht!]
            ...
            \begin{tikzpicture}
                ...
                \node at (-2.3,1.3) {\(e_{g}\)};
                \foreach \i in {-1,0,1}{
                    \draw[arrows = {->[harpoon]},thick] (1.2*\i-0.06,-0.2)--(1.2*\i-0.06,0.4);
                }
                \foreach \i in {-1,0}{
                    \draw[arrows = {->[harpoon]},thick] (1.2*\i+0.06,0.4)--(1.2*\i+0.06,-0.2);
                }
                \foreach \i in {-1,0}{
                    \draw[arrows = {->[harpoon]},thick] (1.2*\i+0.6-0.06,1.1)--(1.2*\i+0.6-0.06,1.7);
                }
    ...
    \begin{ex}
        ...
        \begin{figure}[ht!]
            ...
            \begin{tikzpicture}
                ...
                \node at (-2.3,0) {\(t_{2g}\)};
                \node at (-2.3,1.7) {\(e_{g}\)};
                \draw[arrows = {->[harpoon]},thick] (-1.2,-0.2)--(-1.2,0.4);
                ...
                \draw[arrows = {->[harpoon]},thick] (5.4,-0.6)--(5.4,0);
    ...
    \begin{figure}[ht!]
        ...
        \begin{tikzpicture}
            \node at (0,0){
                ...
                \chemmove{\draw[-,shorten >=5mm,shorten >=1mm](c)..controls +(180:2mm) and +(-65:7mm)..(d);}
                \chemmove{\draw[-,shorten >=5mm,shorten >=1mm](c)..controls +(0:2mm) and +(-115:7mm)..(e);}
            };
    ...
    Before we proceed, let's make clear of two easily confused quantities, the magnetic flux density (or magnetic induction) \(\vb{B}\) and the magnetic field strength \(\vb{H}\). What we've discussed above is the magnetic field strength \(\vb{H}\), which measures the external magnetic field generated by free currents, not counting materials' response. However, when a external field is applied to a media, the media respond to the external field and generates a magnetisation \(\vb{M}\). This magnetisation also generates magnetic fields that can be experienced by other particles in the media, such as a moving charge or other magnetic moments. The total effect is the magnetic flux density
    \begin{equation}
        \vb{B}=\mu_0(\vb{H}+\vb{M})\,,
    \end{equation}
    ...
    In the cgs unit, however, we take a different convention to put this extra \(4\pi\) factor in front of \(\vb{H}\) to somewhere in the Maxwell's equations (which doesn't affect us since we don't bother solving Maxwell's equations) so that now we have
    \begin{equation}
    ...
    \end{equation}
    The combination of constants \(N_A \mu_{\text{B}}^2/3k_B=0.12504\) is coincidentally very close to \(\frac{1}{8}\), which allows us to approximate the Curie's constant as
    \begin{equation}
        C=\frac{N_A \mu_{\text{B}}^2}{3k_B}\approx \frac{1}{8}g^2 S(S+1)\,.
    \end{equation}
    If we take \(g\approx 2\), this gives us the handy formula
    \begin{equation}
        C\approx\frac{1}{2}S(S+1)\,.
    \end{equation}
    ...
    \end{equation}
    Then ferromagnetic interaction has \(J>0\) while antiferromagnetic interaction has \(J<0\).
    ...
    \begin{ex}
        \textit{\(\mathrm{M}(e_g)-\mathrm{O}-\mathrm{M}(e_g)\) in \(\mathrm{[Cu(OH)_2Cu]^{2+}}\) dimer.}
        ...
        \begin{figure}[ht!]
            ...
            \begin{tikzpicture}
                ...
                \draw[arrows = {->[harpoon]},thick,red] (-2.3,0.3)--(-2.3,-0.3);
                \draw[arrows = {->[harpoon]},thick,blue] (2.42,0.3)--(2.42,-0.3);
                \draw[arrows = {->[harpoon]},thick,red] (-1.3,1.3)--(-1.3,1.9);
                \draw[arrows = {->[harpoon]},thick,red] (-1.18,1.9)--(-1.18,1.3);
                \draw[arrows = {->[harpoon]},thick,blue] (1.3,1.9)--(1.3,1.3);
                \draw[arrows = {->[harpoon]},thick,blue] (1.18,1.3)--(1.18,1.9);

                \draw[thick,->] (3.5,0.5)to[bend left=15] node[above,align=center]{\small electron \\ \small transfer} (6,0.5);
                ...
                \begin{scope}[shift={(9.5,0)}]
                    ...
                    \draw[arrows = {->[harpoon]},thick,red] (-2.3,0.3)--(-2.3,-0.3);
                    \draw[arrows = {->[harpoon]},thick,blue] (2.42,0.3)--(2.42,-0.3);
                    \draw[arrows = {->[harpoon]},thick,red] (-2.42,-0.3)--(-2.42,0.3);
                    \draw[arrows = {->[harpoon]},thick,red] (-1.18,1.9)--(-1.18,1.3);
                    \draw[arrows = {->[harpoon]},thick,blue] (1.3,1.9)--(1.3,1.3);
                    \draw[arrows = {->[harpoon]},thick,blue] (2.3,-0.3)--(2.3,0.3);
                \end{scope}
            \end{tikzpicture}
        \end{figure}
